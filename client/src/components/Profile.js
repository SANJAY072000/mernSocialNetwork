...
export default class Profile extends Component {
  ...
  render(){
    return(
      ...
      <Navbar/>
        ...
        <h1 className="display-4 text-center mt-3">Create Your Profile</h1>
  ...
  <button type="submit" className="btn btn-outline-primary mb-5 btn-block"><i className="fa fa-pencil" aria-hidden="true"></i> Create My Profile</button>
</form>
</div>
</div>
    );
